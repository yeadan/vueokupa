...
export default {
  ...
  methods: {
    ...
    get_calles() {
     ...
     console.log(url)
     //https://apiv1.geoapi.es/calles?CPRO=33&CMUM=001&CUN=0103799&CPOS=0103799&type=JSON&key=2fbda50bcbdc4f0d5ff1b7f08546174f90e60e0de4cc83d2f4cab5ea2708a989&sandbox=0
     this.instance.get(url)
      .then(response => {
